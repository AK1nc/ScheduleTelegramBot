...
namespace Dep406Bot.Buttons.Indificators
{
    ...
    /// </summary>
    [Description("SpecialistStudent")]
    internal class SpecialistStudentBT(IChatHistory _db) : IBotCallbackQuery
    {
        ...
        public async Task Realization(ITelegramBotClient client, Update update, CancellationToken cancellationToken)
        {
            ...
            try
            {
                await _db.setIndificator(update.CallbackQuery.Message.Chat.Id, 2);
            }
            catch (Exception ex)
            {
            ...
            (
                new List<InlineKeyboardButton[]>()
                {
                    ...
                    new InlineKeyboardButton[]
                    {
                        ...
                        InlineKeyboardButton.WithCallbackData("4 курс", "4year"),
                        InlineKeyboardButton.WithCallbackData("5 курс", "5year"),
                    },
                }
            );
